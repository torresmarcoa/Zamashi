        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-3 text-neutral-300">
              ...
              <div className="flex items-center space-x-2">
                ...
                <a className="hover:text-white">+52 55 1234 5678</a>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="w-5 h-5 flex-shrink-0" />
                <a className="hover:text-white">hola@zamashi.com</a>
              </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-neutral-300">
              ...
              <div className="flex items-center space-x-2">
                <Phone className="w-5 h-5 flex-shrink-0" />
                <a className="hover:text-white">+52 55 8765 4321</a>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="w-5 h-5 flex-shrink-0" />
                <a className="hover:text-white">hola@kazamashi.com</a>
              </div>
